...
export class NgxBootstrapComponent implements OnInit {
  ...
  // Pagination
  public currentPage = 1; // # of current page to show  现在是第几页
  public itemsPerPage = 2; // # of items per page  每页显示多少条
  public maxSize = 2; // max # of page buttons to show at once
  ...
  onPageChange(page) {
    ...
    const end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : this.masterList.length;
